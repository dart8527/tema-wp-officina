...
<div class="cover" style="background-image:url(<?php echo get_template_directory_uri() ?>/img/birre/BeerTour.jpg);background-repeat:no-repeat;background-size:cover;">
